    ...
    <div className="min-h-screen bg-gradient-to-br from-dark_text to-primary text-white">
      ...
      {selectedImage && (
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="relative w-full max-w-xl bg-gray-900 rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl">
            <button
            ...
            <img
              ...
              className="w-full h-[200px] sm:h-[300px] object-cover mt-20"
            />
            <div className="p-4 sm:p-8 bg-gradient-to-t from-gray-900 to-gray-900/80 backdrop-blur-sm">
              <h3 className="text-2xl sm:text-4xl font-bold mb-2 sm:mb-4 text-text_color">
                {selectedImage.title}
              </h3>
